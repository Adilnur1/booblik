        ...
        <div className="about__container">
          ...
          <div className="AboutMe">
            ...
            <div className="aboutme2">
              ...
              <div className="blok1">
                <div>
                  <p>Благодаря качественным зёрнам, кофе у меня получается насыщенным и ароматным.</p>
              ...
              <div className="blok2">
                ...
                <div>
                  <p>Все лимонады я готовлю только из отборных и натуральных ягод.</p>
                  <img className="limonad" src={limonad} alt="" />
                </div>
              </div>
              <div className="blok3">
                <div>
                  <p>Каждая моя выпечка и десерт готовятся с любовью и только из натуральных ингредиентов на сливочном масле.</p>
              ...
              <div className="blok4">
                ...
                <div>
                  <p>Хлеб, деревенские бублики и<br /> круассаны я тоже пеку сам из свежих натуральных ингредиентов<br /> на сливочном масле, БЕЗ<br /> ДОБАВЛЕНИЯ консервантов.</p>
                  <img className="butters" src={butters} alt="" />
                </div>
              </div>
              <div className="blok5">
                <div>
                  <p>Мои круассаны ты можешь хранить в холодильнике до 3-4 дней, разогреть в духовке и вновь насладиться восхитительным вкусом.</p>
